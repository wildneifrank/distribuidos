...
HOST = '2804:d4b:7a49:3300:8deb:bbed:a2ab:fdf8'  # Endereço IP do servidor
    ...
    while condition:
        try:
            ...
            if message.decode('utf-8').strip() == '/usuarios':
                ...
                broadcast(saida.encode('utf-8'), client_socket)
